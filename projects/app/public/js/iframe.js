function embedChatbot() {
  ...
  const positionStyle = script?.getAttribute('position-style') || 'bottom:30px;right:60px;width:40px;'
  const MessageIcon =
  ...
  ChatBtn.style.cssText =
    'position: fixed; ' + positionStyle + ' cursor: pointer; z-index: 2147483647; transition: 0;';
